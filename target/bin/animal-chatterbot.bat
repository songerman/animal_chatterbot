...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="animal-chatterbot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" telegrambot.Program %CMD_LINE_ARGS%
